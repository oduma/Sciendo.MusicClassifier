...
namespace MusicClassifierML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Code\work\Sciendo\LIE\allArtists.csv";
        private static string MODEL_FILEPATH = @"C:\Users\octo\AppData\Local\Temp\MLVSTools\MusicClassifierML\MusicClassifierML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey(":LABEL", ":LABEL")
                                      ...
                                      .Append(mlContext.Transforms.CopyColumns("Features", "name_tf"))
